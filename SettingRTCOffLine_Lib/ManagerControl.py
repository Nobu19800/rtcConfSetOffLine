...
class ManagerControl:
    ...
    confNameList = [{"default":"localhost","type":TextBox,"list":[],"name":"corba.nameservers","label":u"RTC等を登録するネームサーバ"},
                             {"default":"%h.host_cxt/%n.mgr","type":TextBox,"list":[],"name":"naming.formats","label":u"RTCをネームサーバに登録する際のフォーマット"},
                            ...
                            {"default":"manager","type":TextBox,"list":[],"name":"manager.naming_formats","label":u"managerの名前のフォーマット"},
